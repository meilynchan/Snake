...
function drawSquare(color){
  ...
  ctx.fillStyle = color
  ctx.fillRect(canvas.width/2 - 250, canvas.height/2 - 250, 50, 0)
...
function drawCircle(){
  ctx.fillStyle = 'red'
  ctx.beginPath()
  ctx.arc(canvas.width/2 - 250, canvas.height/2 - 250, canvas.height/4, 0, 0, Math.PI * 3, false)
  ctx.fill()
}
...
setTimeout(() => drawSquare('red'), msUntilLate)
